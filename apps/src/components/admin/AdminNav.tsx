...
const NAV_ITEMS = [
  ...
  { label: 'Hairstyles', href: '/admin/hairstyles', icon: '✁' },
...
export function AdminNav() {
  ...
  return (
    <>
      ...
      {/* Mobile top bar */}
      <header className="lg:hidden sticky top-0 z-40 bg-white/80 backdrop-blur-2xl border-b-2 border-[#8E890D]/30 px-4 pb-2 flex items-center justify-between shadow-sm safe-top">
